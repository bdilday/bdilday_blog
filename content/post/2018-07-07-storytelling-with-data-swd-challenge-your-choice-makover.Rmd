...
kc_df = 
  structure(list(year = c(2005L, 2010L, 2011L, 2012L, 2005L, 2010L, 
2011L, 2012L), location = c("Kansas City", "Kansas City", "Kansas City", 
"Kansas City", "National", "National", "National", "National"
), score = c(100L, 108L, 109L, 111L, 100L, 92L, 91L, 92L)), .Names = c("year", 
"location", "score"), row.names = c(NA, -8L), class = c("tbl_df", 
"tbl", "data.frame"), spec = structure(list(cols = structure(list(
    year = structure(list(), class = c("collector_integer", "collector"
    )), location = structure(list(), class = c("collector_character", 
    "collector")), score = structure(list(), class = c("collector_integer", 
    "collector"))), .Names = c("year", "location", "score")), 
...
``` {r, fig.width=8, fig.height=8, fig.units="in"}
